...
<body style="background: linear-gradient(90deg, #274060 0%,#bbbbff  35%, #ffeeff 100%);"o>
<?php
include("header.php");
?>
<section id="aboutUs">
  <div class="container">
    <div class="heading text-left"> 
      ...
      <div class="wel_line"><center><h3>WELCOME TO FilmDom   </h3></center></div>
    </div>
    <div class="row feature design">

      <div class="area1 columns left">
        
        <h5>FilmDom is the most recognisable ﬁlm exhibition brands in the country which has high standards of ‘Luxury’, ‘Service’ & ‘Technology’.</h5>
        <p style="">Currently with a Cinema circuit of 450 + screens spread across 100+ properties covering 100+ cities across the country.
        The best thing about using it is the simplicity and ease with which a person can book the tickets online.Coming from Latur, that has a rich legacy of cinema, we are a theatre chain with a passion for experiences and an even bigger passion to share them with our customers. We understand the joy of watching our favourite stories come alive on the big screen, and believe that it is our duty to go the extra mile to make this experience as immersive as we possibly can!
                                                ...
                                                <div class="dvPatConetnt">
                                                    <div class="dvPatronDesc">
                                                        ...
                                                        <div class="dvPatronDescText">
                                                           FilmDom is a leading chain of multiplex spread over Maharastra.The multiplex shows Hindi and English movies. It caters best in class cinematic experience to its patrons.
                                                        </div>
                                                    </div>
                                                </div>
