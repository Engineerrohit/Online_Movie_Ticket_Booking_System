...
<div>
	<div class="parent-container" style="background: linear-gradient(90deg, #274060 0%,#bbbbff  35%, #ffeeff 100%);">
		...
		<tr>
			<td align="center" valign="middle">
              ...
              <br><p id="passerror"></p><div id="msg"></div> </td>
					...
					<tr>
						<td align="left"><br />
						<span class="forgetpassword"><a href="forget_password.php" style="text-decoration:none"> Forgot your Password ?</a></span></td>

					</tr>
					<td><a href="register_form.php" style="text-decoration:none"> Register now</a></td>
					<tr>
