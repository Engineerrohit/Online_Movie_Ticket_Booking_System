...
<body style="background: linear-gradient(90deg, #274060 0%,#bbbbff  35%, #ffeeff 100%);">
    <div >
...
<div class="container">
            ...
            <div class="col-lg-7 col-md-7 col-sm-5">
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="checkbox" class="larger" name="seat[]  " value="I1" style="accent-color:green"<?php
                         if(in_array("I1",$seats1)){
                                    echo "disabled";
                                }
                    ?>></td>
                        <td ><input type="checkbox" class="larger" name="seat[]" value="I2" id="co" <?php
    ...
    <div class="col-lg-6">
        ...
        <table>
            ...
            <tr><center>
                <select name="date" id="date" style="border-radius:17px;width:350px;height:45px;text-align:center
                "><b>
                    <option value="1"> 16-04-2024</option>
                    <option value="2">17-04-2024</option>
                    <option value="3">18-04-2024</option>
                    <option value="4">19-04-2024</option>
                    <option value="5">20-04-2024</option>
                    </b></a>
                </select></center>
            </tr><br><br>
            ...
            <tr><td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Theater:</font></td>
                <td> Inox <input type="radio" id="selectedtext" name="theater" placeholder="select theater" value="Inox" required> &nbsp;&nbsp;&nbsp;&nbsp;
                    PVR <input type="radio" id="selectedtext" name="theater" placeholder="select theater" value="PVR">&nbsp;&nbsp;&nbsp;&nbsp;
                    Rama Talkies <input type="radio" id="selectedtext" name="theater" placeholder="select theater" value="Rama Talkies">
                    Yashoda <input type="radio" id="selectedtext" name="theater" placeholder="select theater" value="Yashoda">&nbsp;&nbsp;&nbsp;&nbsp;
                    Filmdom <input type="radio" id="selectedtext" name="theater" placeholder="select theater" value="FilmDom">
                     </td>
            </tr>
